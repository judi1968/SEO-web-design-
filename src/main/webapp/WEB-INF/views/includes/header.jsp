                        ...
                        <div class="navbar-nav header-right">
							...
							<div class="dlab-side-menu">	
								<div class="search-coundry d-flex align-items-center">
									<img src="${pageContext.request.contextPath}/assets/images/United.png" alt="">
														...
														<li>
															<div class="timeline-panel">
																<div class="media me-2">
																	<img alt="image" width="50" src="${pageContext.request.contextPath}/assets/images/avatar/1.jpg">
																</div>
								...
								<ul>
									<li class="nav-item dropdown header-profile">
										<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
											<img src="${pageContext.request.contextPath}/assets/images/profile/pic1.jpg" width="20" alt=""/>
										</a>
										<div class="dropdown-menu dropdown-menu-end">
