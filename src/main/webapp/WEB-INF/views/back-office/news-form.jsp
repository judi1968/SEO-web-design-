<%@page import="com.project.model.table.News" %>
<%
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Ajouter une actualite</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <small class="form-text text-muted">
                                                    Vous pouvez utiliser les balises HTML : &lt;h1&gt;, &lt;h2&gt;, &lt;p&gt;, &lt;ul&gt;, &lt;li&gt;, etc.
                                                </small>
                                            </div>
